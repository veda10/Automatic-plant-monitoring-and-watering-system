    ...
    RGraph.Meter = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.green.start':            ((this.max - this.min) * 0.41) + this.min,
            'chart.green.end':              this.max,
            'chart.green.color':            '#207A20',
            'chart.yellow.start':           ((this.max - this.min) * 0.15) + this.min,
            'chart.yellow.end':             ((this.max - this.min) * 0.41) + this.min,
            'chart.yellow.color':           '#D0AC41',
            'chart.red.start':              this.min,
            'chart.red.end':                ((this.max - this.min) * 0.41) + this.min,
